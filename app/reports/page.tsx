...
const articles = [
  ...
  { slug: "temperature-gated-mechanism-20260903", kind: "研究机制 / 温度门控", title: "温度门控决策机制：从市场温度到投资方案", dek: "市场温度五档→门控选策略→多策略共振加权→质量核验→仓位熔断的完整决策流水线，附9月3日运行版。", date: "2026-09-03", status: "已发布 · 运行于2026-09-03，数据截至2026-09-03" },
