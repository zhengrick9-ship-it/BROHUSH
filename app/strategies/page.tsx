...
const strategies = [
  { name: "周频主策略", state: "当前主用", color: "green", rhythm: "周末制定 / 盘中只查触发", rule: "先判断板块趋势与产业逻辑，再在价值模块中选择具备业务验证和位置优势的个股。", exit: "逻辑失效、板块趋势破坏，或预设的量价退出条件成立。" },
  ...
  { name: "价值链爆发", state: "研究策略", color: "orange", rhythm: "专题更新", rule: "从产业、模块、专题到个股，寻找未来价值迁移中尚未充分定价、具备真实技术或业务壁垒的价值点。", exit: "客户验证、订单兑现、技术路线或现金流证据不支持预期。" },
